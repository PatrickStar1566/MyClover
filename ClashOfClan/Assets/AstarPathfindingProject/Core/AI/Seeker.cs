...
public class Seeker : MonoBehaviour {
	...
	public OnPathDelegate multiplyPathCallback;
	...
	public void OnPathComplete (Path p, bool runModifiers, bool sendCallbacks, bool multiplyPath = false) {
		...
		if (sendCallbacks) {
			...
			if(multiplyPath)
			{
				if(multiplyPathCallback != null)
					multiplyPathCallback(p);
			}
			else
			{
	...
	public void OnMultiPathComplete (Path p) {
		OnPathComplete (p,false,true, true);
	}
